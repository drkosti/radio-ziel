...
<?php include('inc/header.php');?>
    ...
    <title><?php echo $nazwa ?> | Współpraca</title>
  </head>
...
<div class="media art">
  ...
  <div class="media-body">
    <h5 class="mt-0">Współpraca</h5>
    <p>
    	Możemy wymienić się liniem/bannerem... jakieś info...
    	Aby dostosować wygląd i treść tej podstrony edytuj plik <pre>inc/wspolpraca.php</pre>
    </p>
